...
1. Download the `miniImageNet` datasets by the following steps (this will download the orginal ImageNet dataset). If you already downloaded ImageNet dataset, please comment line 5 and line 6 in `./filelists/miniImagenet/download_miniImagenet.sh`
...
2. Download the datasets for evaluation (EuroSAT, ISIC2018, Plant Disease, ChestX-Ray8) using the above links.
